...
export const DEFAULT_DB_STATE: DatabaseState = {
  ...
  professors: {
    "prof-1": {
      id: "prof-1",
      name: "Associate Prof. Dr. Dinesh Kumar Bhatt",
      title: "Campus Chief & Associate Professor",
      faculty: "Education",
      department: "Educational Pedagogy & Leadership",
      qualification: "Ph.D. in Educational Planning, M.Ed. (First Class)",
      subjects: ["Advanced Educational Research", "Curriculum Studies", "Educational Administration"],
      researchInterests: "Higher education accessibility in mountainous Himalayan regions.",
      email: "chief@fsudmc.com",
      officeHours: "Sun, Tue, Thu: 11:30 AM – 1:30 PM",
      imageUrl: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?auto=format&fit=crop&q=80&w=400",
    },
    "prof-2": {
      id: "prof-2",
      name: "Dr. Narendra Singh Karki",
      title: "Professor & Academic Coordinator",
      faculty: "Management",
      department: "Accountancy & Financial Management",
      qualification: "Ph.D. in Financial Economics, M.B.S.",
      subjects: ["Advanced Financial Accounting", "Corporate Finance", "Auditing"],
      researchInterests: "Microfinance systems and mountain enterprise development.",
